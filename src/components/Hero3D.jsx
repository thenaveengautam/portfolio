    ...
    <section className="hero-section relative min-h-[75vh] md:min-h-screen flex items-start md:items-center justify-center overflow-hidden bg-[#0a0a0a] pt-40 md:pt-0 md:pb-0">
      ...
      <div className={`relative z-10 flex flex-col items-center justify-center text-center px-6 max-w-5xl transition-all duration-1000 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        ...
        <div className="flex flex-col items-center w-full translate-y-0 mt-0 md:-translate-y-10 md:-mt-20">
          ...
          <p className="max-w-2xl px-4 mx-auto mb-10 md:mb-20 text-xl md:text-2xl font-normal leading-relaxed text-white/70 shrink-0"
        ...
        {/* CTA Buttons */}
        <div className="flex flex-col items-center justify-center w-full gap-4 mt-2 sm:flex-row sm:gap-6 md:-mt-14 shrink-0">
