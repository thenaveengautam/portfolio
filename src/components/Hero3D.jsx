...
const Hero3D = () => {
  ...
  return (
    <section className="relative min-h-[100svh] md:min-h-screen flex items-center justify-start md:justify-center overflow-hidden bg-[#0a0a0a] pt-20 md:pt-0 md:pb-0">
      ...
      <div className={`relative z-10 flex flex-col items-center justify-center text-center px-6 max-w-5xl transition-all duration-1000 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        ...
        <div className="flex flex-col items-center w-full translate-y-0 md:-translate-y-10 mt-0 md:-mt-20">
          {/* Available for work badge */}
          <div className="mt-0 md:mt-28 mb-6 md:mb-4">
          ...
          >
            <h1 className="font-serif text-[12.5vw] sm:text-6xl md:text-8xl lg:text-[9rem] leading-[1.1] whitespace-nowrap tracking-tight flex items-center justify-center gap-2 md:gap-6 drop-shadow-[0_20px_30px_rgba(0,0,0,0.8)]">
