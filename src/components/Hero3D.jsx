...
const Hero3D = () => {
  ...
  return (
    <section className="relative min-h-[75vh] md:min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a] pt-24 pb-4 md:pt-0 md:pb-0">
      ...
      <div className={`relative z-10 flex flex-col items-center justify-center text-center px-6 max-w-5xl transition-all duration-1000 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        ...
        <div className="flex flex-col items-center w-full -translate-y-10 md:-translate-y-10 -mt-16 md:-mt-20">
